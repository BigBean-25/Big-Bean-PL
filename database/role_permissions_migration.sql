...
SELECT r.id, m.module_key, m.module_name,
  CASE WHEN r.role_name IN ('Super Admin','Admin','Developer') THEN 1 WHEN m.module_key = 'dashboard' THEN 1 ELSE 0 END,
  CASE WHEN r.role_name IN ('Super Admin','Admin','Developer') THEN 1 ELSE 0 END,
  CASE WHEN r.role_name IN ('Super Admin','Admin','Developer') THEN 1 ELSE 0 END,
  CASE WHEN r.role_name IN ('Super Admin','Admin','Developer') THEN 1 ELSE 0 END,
  CASE WHEN r.role_name IN ('Super Admin','Admin','Developer') THEN 1 ELSE 0 END,
  CASE WHEN r.role_name IN ('Super Admin','Admin','Developer') THEN 1 ELSE 0 END,
