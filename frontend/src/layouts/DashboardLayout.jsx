...
const LANGUAGES = {
  en: {
    ...
    locationManagement: "Operational Locations",
    dailyAccounts: "Daily Accounts",
    cashbook: "Cashbook",
    expenses: "Daily Expenses",
    bankDeposits: "Bank Deposits",
    dayClosing: "Day-End Closing",
    checklist: "Day-End Checklist",
    vendorPurchases: "Vendor Purchases",
    vendorLedgerPayments: "Vendor Ledger & Payments",
    ...
    purchases: "Purchases",
    materialPurchase: "Raw Material Purchases",
    supplierPayments: "Supplier Ledger & Payments",
    sales: "Sales",
    itemSales: "Item Sales",
    dailySalesUpload: "Daily Sales",
    monthlySalesUpload: "Monthly Sales",
    itemTaxUpload: "Item Tax",
    recipe: "Recipe / SOP",
    recipeList: "All Recipes",
    addRecipe: "Add Recipe",
    payouts: "Month-End Entries",
    onlinePayouts: "Online Order Settlements",
    dineInPayouts: "Dine-in Settlements",
    reports: "Reports",
    dailyCashbookReport: "Cashbook",
    expenseReport: "Expense",
    actualConsumption: "Actual Consumption",
    theoreticalConsumption: "Theoretical Consumption",
    supplierPending: "Supplier Outstanding",
    ...
    centralKitchen: "Central Kitchen & Bakehouse",
    centralKitchenDashboard: "Bakehouse Dashboard",
    centralKitchenRequests: "Requests",
    centralKitchenPlanning: "Plans",
    ...
    receiveDispatch: "Outlet Receiving",
    search: "Search ⌘K",
    ...
    const items = [
      ...
      },
      {
        ...
        submenu: [
          ...
          ...(canView("warehouse_reports") ? [{ title: t.outletWastageByCategory, path: "/outlet-dashboard/wastage-by-category", group: "Wastage" }] : []),
