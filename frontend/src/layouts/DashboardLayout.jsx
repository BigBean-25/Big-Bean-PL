...
const LANGUAGES = {
  en: {
    ...
    warehouseGRN: "Goods Receipt Notes",
    ...
    warehouseWastage: "Warehouse Wastage",
    ...
    centralKitchenRequests: "Production Requests",
    centralKitchenPlanning: "Production Plans",
    centralKitchenBatches: "Production Batches",
    centralKitchenWastage: "Production Wastage",
    centralKitchenVariance: "Production Variance",
    centralKitchenDispatches: "Outlet Dispatches",
    centralKitchenFinishedStock: "Finished Stock",
    receiveDispatch: "Outlet Receiving / Bakehouse Receipts",
    search: "Search ⌘K",
