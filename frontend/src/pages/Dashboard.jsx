...
const StatCard = ({
  ...
  return (
    <div className="rounded-md border border-[#EBE9F1] bg-white p-6 shadow-[0_2px_12px_rgba(47,43,61,0.08)]">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-[20px] font-semibold text-[#2F2B3D]">{title}</p>
          <p className="mt-1 text-[15px] text-[#A8AAAE]">{subtitle}</p>
        </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-5 flex items-end justify-between gap-3">
          <h3 className="text-[30px] font-semibold leading-none text-[#2F2B3D]">
            {value}
          </h3>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-5">
          ...
          <div className={`rounded-md border p-6 shadow-[0_2px_12px_rgba(47,43,61,0.08)] ${cardClass}`}>
            ...
            <div className="mt-7 flex items-end justify-between gap-5">
              <div>
                <p className={`text-[34px] font-semibold ${mainTextClass}`}>
                  ₹4,673
                </p>
            ...
            {[
              ...
              return (
                <button
                  key={alert.title}
                  type="button"
                  className="flex items-center gap-4 rounded-md border border-[#EBE9F1] bg-white p-4 text-left shadow-[0_2px_12px_rgba(47,43,61,0.06)] transition hover:-translate-y-0.5"
                >
                  <div
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-[13px] text-[#6F6B7D]">
                      {alert.sub}
                    </p>
                  </div>
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1fr_460px]">
          <div className={`rounded-md border p-6 shadow-[0_2px_12px_rgba(47,43,61,0.08)] ${cardClass}`}>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-5">
              {[
                ...
                return (
                  <button
                    ...
                    className="flex h-[115px] flex-col items-center justify-center rounded-md border border-dashed text-center transition"
                    style={{
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundColor: active ? `${primaryColor}18` : "#F3F2F7",
                      }}
                    >
                      <Icon size={23} />
                    </div>
              ...
              <button
                type="button"
                className="flex h-[115px] flex-col items-center justify-center rounded-md border border-dashed border-[#DBDADE] text-center text-[#A8AAAE]"
              >
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1fr_430px]">
          <div className={`rounded-md border p-6 shadow-[0_2px_12px_rgba(47,43,61,0.08)] ${cardClass}`}>
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
              ...
              <div className="flex rounded-md border border-[#DBDADE] p-1">
          ...
          <div className={`rounded-md border p-6 shadow-[0_2px_12px_rgba(47,43,61,0.08)] ${cardClass}`}>
            ...
            <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-[1fr_140px] xl:grid-cols-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-md border border-[#DBDADE] bg-white pl-11 pr-4 text-[14px] outline-none focus:border-[#7367F0]"
                />
              </div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="h-11 w-full appearance-none rounded-md border border-[#DBDADE] bg-white pl-11 pr-4 text-[14px] outline-none focus:border-[#7367F0]"
                >
            ...
            <div className="mt-5 space-y-2">
              {filteredTransactions.length === 0 ? (
                ...
                filteredTransactions.map((tx) => (
                  <div
                    key={tx.id}
                    className="flex items-center justify-between gap-3 rounded-md p-3 transition hover:bg-[#F8F7FA]"
                  >
            ...
            <button
              ...
              className="mt-5 flex w-full items-center justify-center gap-2 rounded-md border border-[#DBDADE] px-4 py-3 text-[15px] font-medium text-[#6F6B7D] hover:bg-[#F8F7FA]"
            >
        ...
        <div className={`rounded-md border p-6 shadow-[0_2px_12px_rgba(47,43,61,0.08)] ${cardClass}`}>
          <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-2 rounded-md bg-[#F8F7FA] px-4 py-2 text-[13px] font-medium text-[#6F6B7D]">
            ...
            {quickActions.map((action) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-center gap-3 rounded-md border border-[#EBE9F1] bg-[#F8F7FA] p-5 text-center transition hover:-translate-y-0.5 hover:bg-white hover:shadow-[0_4px_18px_rgba(47,43,61,0.12)]"
                >
                  <div
                    className="flex h-12 w-12 items-center justify-center rounded-md"
                  ...
                  <span className="text-[14px] font-medium text-[#5D596C]">
                    {action.label}
                  </span>
                </button>
              );
