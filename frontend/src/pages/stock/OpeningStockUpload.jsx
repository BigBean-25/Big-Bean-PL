  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Opening Stock Upload</h1>
          <p className="text-gray-600 mt-1">Upload monthly opening stock via Excel</p>
        </div>
      ...
      <div className="card">
        <h3 className="text-lg font-semibold mb-4">Upload Opening Stock</h3>
