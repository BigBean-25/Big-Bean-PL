...
const sections = [
  ...
  { title: "Goods Receipt (GRN) Controls", keys: ["require_po_for_grn","allow_manual_grn","allow_over_receipt","over_receipt_tolerance_pct","require_rejected_qty_reason","require_batch_for_batch_tracked","require_expiry_for_expiry_tracked"] },
  { title: "Outlet Purchase Order / Dispatch Controls", keys: ["allow_partial_approval","allow_partial_dispatch","require_warehouse_approval","require_outlet_receipt_confirmation"] },
  ...
  { title: "Warehouse Purchase Order Controls", keys: ["require_po_approval","allow_creator_approve_own_po","allow_po_without_expected_delivery","default_payment_terms"] },
...
export default function WarehouseSettings({ locationId, locations, isDark }) {
  ...
  const renderLabel = (key) => {
    const map = {
      ...
      fefo_enabled: "FEFO (First-Expired-First-Out) Enabled", require_physical_count_verification: "Require Verification",
      ...
      default_payment_terms: "Default Payment Terms", require_original_grn_for_return: "Require Original Goods Receipt (GRN)",
      require_purchase_return_approval: "Require Approval", require_supplier_credit_tracking: "Require Supplier Credit Tracking",
      po_prefix: "PO Prefix", grn_prefix: "Goods Receipt (GRN) Prefix", req_prefix: "Outlet PO Prefix",
      trf_prefix: "Transfer Prefix", phy_prefix: "Physical Stock Count Prefix", adj_prefix: "Adjustment Prefix",
